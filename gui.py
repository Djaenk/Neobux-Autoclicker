...
class Application(tkinter.Tk):
    ...
    _LOADING_IMAGE_BASE64 = ("iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAYAAABzenr0AAACuklEQVRYhcWXoW/iUBzH39+AQC2E"
    ...
    def init_login_prompt(self):
        ...
        self.captcha_frame = tkinter.Frame(self.login_prompt)
        self.captcha_frame.grid(row = 3, column = 0, sticky = tkinter.E)
        self.captcha_label = tkinter.Label(self.captcha_frame, text = "Verification Code:")
    ...
    def neobux_login(self):
        ...
        self.loading_graphic.grid(row = 1, column = 0)
    ...
    def init_loading_graphic(self):
        ...
        self.rotate_load_graphic = self._update_loading_graphic().__next__
        self.rotate_load_graphic()
    
    def _update_loading_graphic(self):
        loading_image = Image.open(BytesIO(b64decode(Application._LOADING_IMAGE_BASE64)))
        angle = 0
        while True:
            ...
            self.after(58, self.rotate_load_graphic)
            yield
